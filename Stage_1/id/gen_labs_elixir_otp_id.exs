...
defmodule LabGenerator do
  ...
  EEx.function_from_string(
    ...
    ### 💻 Live Execution
    Gunakan sel eksekusi Elixir di bawah ini untuk mengetik setiap contoh secara manual dan membangun memori otot yang bertahan lama. 💡 Pro Tip: Anda dapat menambahkan lebih banyak sel eksekusi dengan mengeklik tombol + Elixir di bagian bawah bagian mana pun.
...
LabGenerator.run("elixir_otp_id.csv")
