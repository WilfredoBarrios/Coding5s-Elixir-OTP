...
defmodule LabGenerator do
  ...
  EEx.function_from_string(
    ...
    SI dostarczy od 3 do 5 praktycznych przykładów. Aby zbudować trwałą pamięć mięśniową, wpisz każdy przykład ręcznie w poniższej komórce. Przeanalizuj dostarczone analogie i uważnie przeczytaj komentarze w kodzie — zawierają one logikę architektoniczną niezbędną do opanowania tego tematu. Po prostu skopiuj i wklej poniższą treść do czatu SI, a następnie wyślij.
    ...
    To jest prompt mentora. Skopiuj go i wklej do swojego asystenta SI wraz z kodem i krótkim wyjaśnieniem logiki (wszystko w jednej wiadomości). Używaj go do debugowania błędów, profesjonalizacji kodu, proszenia o nowe wyzwania lub uzyskania głębszych wyjaśnień. Możesz także zadawać mentorowi konkretne pytania lub prosić o nowe zadania, aby sprawdzić swoje umiejętności. Ten elitarny symulator mentora zapewnia najwyższej klasy informacje zwrotne, które pozwolą Ci wyostrzyć intuicję inżynierską.
    ...
    ### 💻 Live Execution
    Użyj poniższej komórki wykonawczej Elixir, aby ręcznie wpisać każdy przykład i zbudować trwałą pamięć mięśniową. 💡 Pro Tip: Możesz dodać więcej komórek wykonawczych, klikając przycisk + Elixir na dole dowolnej sekcji.
...
LabGenerator.run("elixir_otp_pl.csv")
