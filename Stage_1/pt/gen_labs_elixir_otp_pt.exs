...
defmodule LabGenerator do
  ...
  EEx.function_from_string(
    ...
    A IA entregará de 3 a 5 exemplos práticos. Para criar uma memória muscular duradoura, digite cada exemplo manualmente na célula abaixo. Analise as analogias fornecidas e leia os comentários no código com atenção — eles contêm a lógica arquitetônica necessária para dominar este tópico. Basta copiar e colar o seguinte no seu chat de IA e enviar.
    ...
    Este é o prompt do mentor. Copie e cole no seu assistente de IA junto com seu código e uma breve explicação da sua lógica (tudo em uma única mensagem). Use-o para depurar erros, profissionalizar seu código, solicitar um novo desafio ou obter uma explicação mais profunda. Você também pode fazer perguntas específicas ao mentor ou solicitar novos desafios para testar suas habilidades. Este simulador de mentor de elite oferece feedback de alto nível para apurar sua intuição de engenharia.
    ...
    ### 💻 Live Execution
    Use a célula de execução Elixir abaixo para digitar manualmente cada exemplo e criar uma memória muscular duradoura. 💡 Pro Tip: Você pode adicionar mais células de execução clicando no botão + Elixir na parte inferior de qualquer seção.
...
LabGenerator.run("elixir_otp_pt.csv")
