...
defmodule LabGenerator do
  ...
  EEx.function_from_string(
    ...
    La IA entregará de 3 a 5 ejemplos prácticos. Para desarrollar una memoria muscular duradera, escribe cada ejemplo manualmente en la celda de abajo. Analiza las analogías proporcionadas y lee atentamente los comentarios en el código; contienen la lógica arquitectónica que necesitas para dominar este tema. Simplemente copia y pega lo siguiente en tu chat de IA y envíalo.
    ...
    Este es el prompt del mentor. Cópialo y pégalo en tu asistente de IA junto con tu código y una breve explicación de tu lógica (todo en un solo mensaje). Úsalo para depurar errores, profesionalizar tu código, solicitar un nuevo desafío o profundizar en una explicación. También puedes hacer preguntas específicas al mentor o pedir nuevos retos para poner a prueba tus habilidades. Este simulador de mentor de élite ofrece retroalimentación de primer nivel para agudizar tu intuición de ingeniería.
...
LabGenerator.run("elixir_otp_es.csv")
